      ...
      setup() {
            ...
            var data_delivery_column = ref<Restaurant[]>([]);
              ...
              const makeDataDelivery = async () => {
                ...
                try {
                    const response = await axios.get('http://localhost:3013/restaurants/6491e3932704d2658d660cd1');
                    var proximityRestaurants = response.data; // Assuming the data is an array of restaurants
